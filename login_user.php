...
<body>
  ...
  unset($_SESSION['regis']); } ?>
                ...
                <!-- Submit button -->
                <button type="button" class="btn btn-info btn-block" id="sub">Login</button>
                <a href="register.php" class="btn btn-danger btn-block">Register</a>
                <!-- Back Index -->
                <a href="index.php" class="btn btn-dark btn-block"><b>Back</b></a>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer class="bg-light text-lg-start">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      <a class="text-primary"> <marquee><B>WELCOME TO HOTEL ALANA. LOGIN NOW!<B></marquee></a>
    </div>
    <!-- Copyright -->
  </footer>
  <!--Footer-->
