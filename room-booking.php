...
<head>
    ...
    <title>Alana Hotel | Room Booking</title>
...
?>
                                    <div class="booking-box1 mb-15 fix">
                                        <div class="booking-filed">
                                            <input type="text" name="nama" placeholder="your name" id="username">
                                        </div>
                                    </div>
                                    <div class="booking-box2 mb-15 fix">
                                        <div class="b_date">
                                            <input class="date-picker" type="text" placeholder="Arrive Date" name="tgl_in">
                                            <i class="mdi mdi-calendar-text"></i>
                                        </div>
                                        <div class="b_date">
                                            <input class="date-picker" type="text" placeholder="Departure Date" name="tgl_out">
                                            <i class="mdi mdi-calendar-text"></i>
                                        </div>
                                    </div>
                                    <div class="select-book mb-15 fix">
                                        <select name="jml_kamar" id="type">
                                            <option value="kmar" selected >Jumlah kamar</option>
                                        ...
                                        <div class="select-book mb-15 fix">
                                        <select name="jml_orang" id="type">
                                            <option value="kmar" selected >Jumlah Orang</option>
                                                <option value="1" >1</option>
                                                <option value="2" >2</option>
                                                <option value="3" >3</option>
                                    ...
                                    <div class="select-book mb-15 fix">
                                        <select name="kamar" id="type">
                                            <option value="kamar" selected disabled>Tipe kamar</option>
