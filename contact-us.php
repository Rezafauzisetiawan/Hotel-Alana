...
<head>
    ...
    <title>Alana Hotel | Contact us</title>
                            ...
                            <div class="contact-adresses">
                                <div class="phone mb-15">
                                    <p>
                                        ...
                                        <span class="desc">0881 0235 3072 2</span>
                                    </p>
                                </div>
                                <div class="mail mb-15">
                                    <p>
                                    <span><i class="mdi mdi-email"></i></span>
                                    <span class="desc">munchen1903@gmail.com</span>
                                    </p>
                                </div>
                                <div class="addresses">
                                    <p>
                                        <span><i class="mdi mdi-map-marker"></i></span>
                                        <span class="desc">Jalan Raya Batujajar No.275 Kecamatan Batujajar Kab. Bandung Barat</span>
                                    </p>
                                </div>
                            </div>
