                            ...
                            <div class="row">
                                <div class="col-md-10 col-sm-10 hidden-xs">
                                    <div class="header-top ptb-10">
                                        <div class="adresses">
                                            <div class="phone">
                                                <p>call <span>0881 0235 3072 2 </span></p>
                                            </div>
                                            <div class="email">
                                                <p>Email: <span>munchen1903@gmail.com</span></p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="menu-list hidden-sm hidden-xs">
                                            <nav>
                                                <ul>
                                                    ...
                                                    <li><a href="room-booking.php">Room booking</a></li>
                                                                                                            <li><a href="#">User | radit<i class="fa fa-angle-down"></i></a>
                                                            <ul class="dropdown_menu">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-7">
                            <div class="welcome-text">
                                <h2>
                                    <span>WELCOME TO</span> <span class="coloring">Alana</span>
                                </h2>
                                <h1 class="cd-headline clip">
                                    <span>THE BEAUTIFULL</span>
                                    <span class="cd-words-wrapper coloring">
                                        <b class="is-visible"> ROOMS</b>
                                        <b>VIEWS</b>
                                    </span>
                                </h1>
                                <p class="welcome-desc"><marquee></marquee></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title mb-80">
                            <h2>About <span>Alana</span></h2>
                         </div>
                    </div>
                    <div class="col-md-12">
                        <div class="about-alana">
                            <div class="about-member">
                                <img src="images/hrd.jpg" alt="">
                                <h3>Reza Fauzi</h3>
                    ...
                    <div class="row">
                        <div class="carousel-list">
                                    ...
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="#"><img class="img-fluid" src="images/room/img4.jpg" height="370px"></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
                                                <h3><a href="#">standart</a></h3>
                                            </div>
                                            <div class="room-rent">
                                                <h5>Rp. 1.000.000 / <span>Night</span></h5>
                                            </div>
                                            <div class="room-book">
                                                <a href="room-booking.php?room=1">Book now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="#"><img class="img-fluid" src="images/room/img1.jpg" height="370px"></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
                                                <h3><a href="#">superior</a></h3>
                                            </div>
                                            <div class="room-rent">
                                                <h5>Rp. 2.000.000 / <span>Night</span></h5>
                                            </div>
                                            <div class="room-book">
                                                <a href="room-booking.php?room=2">Book now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="#"><img class="img-fluid" src="images/room/img3.jpg" height="370px"></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
                                            ...
                                            <div class="room-rent">
                                                <h5>Rp. 3.000.000 / <span>Night</span></h5>
                                            </div>
                                            <div class="room-book">
                                                <a href="room-booking.php?room=3">Book now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="single-footer mt-0">
                            <div class="f-adress">
                                <p><span>Address:</span>Jalan Raya Batujajar No.275 Kecamatan Batujajar Kab. Bandung Barat</p>
                            </div>
                            <div class="hotel-contact">
                                <p><span>phone:</span>0881 0235 3072 2</p>
                                <p><span>Email:</span>munchen1903@gmail.com</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        <p>Copyright© Alana 2018.All right reserved.Created by Rezafauzi <a href="https://freethemescloud.com/"> Free themes Cloud</a></p>
                    </div>
