...
<head>
    ...
    <title>Alana Hotel | Gallery</title>
                                ...
                                <div class="col-md-10 col-sm-10 hidden-xs">
                                    <div class="header-top ptb-10">
                                        <div class="adresses">
                                            ...
                                            <div class="email">
                                                <p>Email: <span>alana@example.com</span></p>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-gallery-img mb-60">
                                <a href="images/gallery/item3/g-1.jpg"><img src="images/gallery/item3/img1.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-gallery-img mb-30">
                                <a href="images/gallery/item3/g-2.jpg"><img src="images/gallery/item3/img2.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-gallery-img mb-30">
                                <a href="images/gallery/item3/g-3.jpg"><img src="images/gallery/item3/img3.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-gallery-img mb-30">
                                <a href="images/gallery/item3/g-4.jpg"><img src="images/gallery/item3/img4.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-gallery-img mb-30">
                                <a href="images/gallery/item3/g-5.jpg"><img src="images/gallery/item3/img5.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-gallery-img mb-30">
                                <a href="images/gallery/item3/g-6.jpg"><img src="images/gallery/item3/img6.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-gallery-img">
                                <a href="images/gallery/item3/g-7.jpg"><img src="images/gallery/item3/img7.jpg" alt=""></a>
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        <p>Copyright© Alana 2018.All right reserved. Created by Rezafauzi</p>
                    </div>
